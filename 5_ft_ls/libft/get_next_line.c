...
/*   Updated: 2019/02/12 14:42:45 by kcarrot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int		reading(t_list **head, int fd, char **str, char *buf)
{
	int		i;
	char	*tmp;
...
static int		create_list(t_list **head, int fd, char **str)
{
	char	*tmp;
	t_list	*p;
...
static int		check_fd(t_list *head, int fd, char **str)
{
	t_list	*p;
	char	*tmp;
	size_t	i;

...
int		reading(t_gnl **head, int fd, char **str, char *buf)
{
	int		i;
	char	*tmp;
...
int		create_list(t_gnl **head, int fd, char **str)
{
	char	*tmp;
	t_gnl	*p;
...
int		check_fd(t_gnl *head, int fd, char **str)
{
	t_gnl	*p;
	char	*tmp;
	size_t	i;
